    ...
    render() {
        ...
        return (
            <>
                ...
                {this.props.newToken && <input type="checkbox" className={`checkbox mr-3 like ${this.props.itinerary._id}`} id={`${this.props.itinerary._id}`} onChange={likeOrDislikeItinerary} />}
